...
public class GazeImageFeedback : MonoBehaviour
{
    ...
    public void GetImage(ToggleImage toggleImage)
    {
        if (toggleImage == null || toggleImage.dataItem == null || toggleImage.dataItem.img_link == "")
        {
            Debug.Log("ToggleImage or dataItem is null. Cannot toggle similarity.");
            Debug.Log("Check toggleImage", toggleImage);
            Debug.Log("Check dataItem" + toggleImage.dataItem.img_link);
            return;
        }
        Debug.Log("GazeImageFeedback" + toggleImage.dataItem.img_link);

        string img_link = toggleImage.dataItem.img_link;
        ...
        newImage.GetComponent<ToggleImage>().Setup(toggleImage.dataItem); // Set up the toggle with the data item
