...
namespace EnhancedScrollerDemos.GridSimulation
{
    ...
    {
        public Texture2D pictureExample;
        ...
        /// </summary>
        public GridRowView cellViewPrefab;
        ...
        private void LoadData()
        {
            ...
            {
                _data.Add(new Data() { picture = pictureExample});
            }
        ...
        public EnhancedScrollerCellView GetCellView(EnhancedScroller scroller, int dataIndex, int cellIndex)
        {
            ...
            GridRowView gridRowView = scroller.GetCellView(cellViewPrefab) as GridRowView;

            gridRowView.name = "Cell " + (dataIndex * numberOfCellsPerRow).ToString() + " to " + ((dataIndex * numberOfCellsPerRow) + numberOfCellsPerRow - 1).ToString();

            // pass in a reference to our data set with the offset for this cell
            gridRowView.SetData(ref _data, numberOfCellsPerRow,dataIndex * numberOfCellsPerRow);
